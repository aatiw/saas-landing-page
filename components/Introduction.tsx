...
export default function Introduction() {
  ...
  return (
    <section ref={scrollTarget} className="py-6 px-12 overflow-x-hidden">
      <div className="container">
        <div className="sticky top-20 md:top-28 lg:top-40">
          ...
          <div className="text-4xl md:text-6xl lg:text-7xl text-center font-medium mt-10 max-w-4xl mx-auto break-words">
